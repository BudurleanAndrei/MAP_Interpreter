...
public class MainWindow{
    public TableView<LatchEntry> tableViewLatchTable;
    public TableColumn<LatchEntry, String> latchTableLatch;
    public TableColumn<LatchEntry, String> latchTableCountdown;
    @FXML
    ...
    private void showDataForSelectedExample(RunExample example) {
        ...
        tableViewLatchTable.getItems().clear();
        ...
        programState.getLatchTable().getContent().forEach((latch, countdown) -> tableViewLatchTable.getItems().add(
                new LatchEntry(latch, countdown)));
    ...
    private void initialize(){
        ...
        latchTableLatch.setCellValueFactory(new PropertyValueFactory<LatchEntry, String>("latchLatch"));
        latchTableCountdown.setCellValueFactory(new PropertyValueFactory<LatchEntry, String>("latchCountdown"));

...
public class MainWindow{
    ...
    public TableView<SemaphoreTableEntry> tableViewSemaphoreTable;
    public TableColumn<SemaphoreTableEntry, String> semaphoreTableIndex;
    public TableColumn<SemaphoreTableEntry, String> semaphoreTableValue;
    public TableColumn<SemaphoreTableEntry, String> semaphoreTableList;
    ...
    private void showDataForSelectedExample(RunExample example) {
        ...
        tableViewSemaphoreTable.getItems().clear();
        ...
        programState.getSemaphoreTable().getContent().forEach((integer, triple) ->
                tableViewSemaphoreTable.getItems().add(new SemaphoreTableEntry(integer, triple.getValue0() - triple.getValue2(),
                        triple.getValue1())));
    ...
    private void initialize(){
        semaphoreTableIndex.setCellValueFactory(new PropertyValueFactory<SemaphoreTableEntry, String>("Index"));
        semaphoreTableValue.setCellValueFactory(new PropertyValueFactory<SemaphoreTableEntry, String>("Value"));
        semaphoreTableList.setCellValueFactory(new PropertyValueFactory<SemaphoreTableEntry, String>("List"));

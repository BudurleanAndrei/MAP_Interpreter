...
public class SelectWindow {
    ...
    public void initialize() throws Exception{
        ...
        IStatement statement14 = new CompoundStatement(new DeclareStatement("b", new BoolType()),
            new CompoundStatement(new DeclareStatement("c", new IntType()),
                    new CompoundStatement(new AssignStatement("b", new ValueExpression(new BoolValue(true))),
                            new CompoundStatement(new ConditionalAssignStatement("c",
                                    new VariableExpression("b"),
        ...
        IStatement statement15 =
                new CompoundStatement(
                        new DeclareStatement("v1", new ReferenceType(new IntType())),
                        new CompoundStatement(
                                new DeclareStatement("cnt", new IntType()),
                                new CompoundStatement(
                                        new NewStatement("v1", new ValueExpression(new IntValue(2))),
                                        new CompoundStatement(
                                                new NewSemaphore("cnt", new HeapReadExpression(new VariableExpression("v1")),
                                                        new ValueExpression(new IntValue(1))),
                                                new CompoundStatement(
                                                        new ForkStatement(
                                                                new CompoundStatement(
                                                                ...
                                                                new ForkStatement(
                                                                        new CompoundStatement(
                                                                                ...
                                                                                new CompoundStatement(
                                                                                        ...
                                                                                        new CompoundStatement(
                                                                                                new HeapWriteStatement("v1",
                                                                                                        new ArithmeticExpression(new HeapReadExpression(new VariableExpression("v1")),
